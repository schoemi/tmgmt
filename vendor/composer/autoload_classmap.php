...
return array(
    ...
    'TMGMT_Action_Handler' => $baseDir . '/includes/class-action-handler.php',
    'TMGMT_Action_Post_Type' => $baseDir . '/includes/post-types/class-action-post-type.php',
    'TMGMT_Admin_Menu' => $baseDir . '/includes/class-admin-menu.php',
    'TMGMT_Appointment_List' => $baseDir . '/includes/class-appointment-list.php',
    'TMGMT_Assets' => $baseDir . '/includes/class-assets.php',
    'TMGMT_Communication_Manager' => $baseDir . '/includes/class-communication-manager.php',
    'TMGMT_Confirmation_Manager' => $baseDir . '/includes/class-confirmation-manager.php',
    'TMGMT_Connection_Settings' => $baseDir . '/includes/class-connection-settings.php',
    'TMGMT_Contact_Post_Type' => $baseDir . '/includes/post-types/class-contact-post-type.php',
    'TMGMT_Contract_Generator' => $baseDir . '/includes/class-contract-generator.php',
    'TMGMT_Contract_Template_Post_Type' => $baseDir . '/includes/post-types/class-contract-template-post-type.php',
    'TMGMT_Customer_Access_Manager' => $baseDir . '/includes/class-customer-access-manager.php',
    'TMGMT_Dashboard' => $baseDir . '/includes/class-dashboard.php',
    'TMGMT_Email_Template_Post_Type' => $baseDir . '/includes/post-types/class-email-template-post-type.php',
    'TMGMT_Event_Meta_Boxes' => $baseDir . '/includes/post-types/class-event-meta-boxes.php',
    'TMGMT_Event_Post_Type' => $baseDir . '/includes/post-types/class-event-post-type.php',
    'TMGMT_Event_Status' => $baseDir . '/includes/post-types/class-event-status.php',
    'TMGMT_Frontend_Dashboard' => $baseDir . '/includes/class-frontend-dashboard.php',
    'TMGMT_Frontend_Manager' => $baseDir . '/includes/frontend/class-frontend-manager.php',
    'TMGMT_General_Settings' => $baseDir . '/includes/class-general-settings.php',
    'TMGMT_IMAP_Connector' => $baseDir . '/includes/class-imap-connector.php',
    'TMGMT_Integration_Debug_Log' => $baseDir . '/includes/class-integration-debug-log.php',
    'TMGMT_Integration_Manager' => $baseDir . '/includes/class-integration-manager.php',
    'TMGMT_Integration_Settings' => $baseDir . '/includes/class-integration-settings.php',
    'TMGMT_Invoice_Post_Type' => $baseDir . '/includes/post-types/class-invoice-post-type.php',
    'TMGMT_Kanban_Column_Post_Type' => $baseDir . '/includes/post-types/class-kanban-column-post-type.php',
    'TMGMT_Live_Tracking' => $baseDir . '/includes/class-live-tracking.php',
    'TMGMT_Location_Post_Type' => $baseDir . '/includes/post-types/class-location-post-type.php',
    'TMGMT_Log_Manager' => $baseDir . '/includes/class-log-manager.php',
    'TMGMT_Mail_Assigner' => $baseDir . '/includes/class-mail-assigner.php',
    'TMGMT_Mail_Queue' => $baseDir . '/includes/class-mail-queue.php',
    'TMGMT_Mail_Queue_Admin' => $baseDir . '/includes/class-mail-queue-admin.php',
    'TMGMT_PDF_Generator' => $baseDir . '/includes/class-pdf-generator.php',
    'TMGMT_Placeholder_Parser' => $baseDir . '/includes/class-placeholder-parser.php',
    'TMGMT_REST_API' => $baseDir . '/includes/class-rest-api.php',
    'TMGMT_Reply_Handler' => $baseDir . '/includes/class-reply-handler.php',
    'TMGMT_Roles' => $baseDir . '/includes/class-roles.php',
    'TMGMT_SMTP_Sender' => $baseDir . '/includes/class-smtp-sender.php',
    'TMGMT_Service_Post_Type' => $baseDir . '/includes/post-types/class-service-post-type.php',
    'TMGMT_Setlist_Post_Type' => $baseDir . '/includes/post-types/class-setlist-post-type.php',
    'TMGMT_Settings_Menu' => $baseDir . '/includes/class-settings-menu.php',
    'TMGMT_Shuttle_Post_Type' => $baseDir . '/includes/post-types/class-shuttle-post-type.php',
    'TMGMT_Status_Definition_Post_Type' => $baseDir . '/includes/post-types/class-status-definition-post-type.php',
    'TMGMT_Title_Post_Type' => $baseDir . '/includes/post-types/class-title-post-type.php',
    'TMGMT_Tour_Manager' => $baseDir . '/includes/class-tour-manager.php',
    'TMGMT_Tour_Overview' => $baseDir . '/includes/class-tour-overview.php',
    'TMGMT_Tour_Post_Type' => $baseDir . '/includes/post-types/class-tour-post-type.php',
    'TMGMT_Veranstalter_Post_Type' => $baseDir . '/includes/post-types/class-veranstalter-post-type.php',
    'TMGMT_Webhook_Post_Type' => $baseDir . '/includes/post-types/class-webhook-post-type.php',
